...
const Dash = () => {
  ...
  return (
    <div className="grid grid-rows-2 grid-cols-2 h-full w-full">
      ...
      <div
        className={`animated ${animationClass} shadow-2xl  border-2 border-white bg-gradient-to-br from-teal-500 to-teal-300 p-4 m-2 flex items-center justify-center rounded-lg`}
      >
        <h2 className="text-white text-3xl font-bold">
